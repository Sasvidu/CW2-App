...
import Order.OrderItemBuilder;
import Repositories.FlavorRepository;
import Repositories.SyrupRepository;
import Repositories.ToppingRepository;
...
public class IceCreamBuilder implements OrderItemBuilder {
    ...
    public IceCreamBuilder setFlavor(String flavorName) {
        ...
        if(this.flavor == null){
            throw new IllegalArgumentException("Order.IceCream.Flavor " + flavorName + " doesn't exist");
        }
        return this;
    }
    ...
    public IceCreamBuilder addToppings(List<String> toppingNames) {
        ...
        for (String toppingName : toppingNames) {
            ...
            if(topping == null){
                throw new IllegalArgumentException("Order.IceCream.Topping " + toppingName + " doesn't exist");
            }else{
    ...
    public IceCreamBuilder addSyrups(List<String> syrupNames) {
        ...
        for (String syrupName : syrupNames) {
            ...
            if(syrup == null){
                throw new IllegalArgumentException("Order.IceCream.Syrup " + syrupName + " doesn't exist");
            }else{
